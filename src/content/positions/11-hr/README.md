...
- **Структурная проблема в проблемных филиалах** — в Краснодаре с 3 локациями набрано слишком много тьюторов → каждому достаётся мало учеников → низкая зарплата → текучка. Это **не HR-проблема в чистом виде**, но HR её первой замечает и должен сигналить собственнику
...
| Часть | Размер |
|---|---|
| **Оклад** | 60-80 тыс ₽ (Татарстан, 1 человек на сеть) |
| **Бонус за закрытие вакансий вовремя** | 5-10 тыс ₽/мес (если ≥ 90% закрыто в срок) |
| **Бонус за прохождение испытательного срока новичками** | 1-2 тыс ₽ за каждого, кто прошёл |
| **Бонус за удержание (год)** | 30-50 тыс ₽ — если текучка тьюторов ≤ 15% по году |
| **Премия годовая** | 0.5-1.0 оклада |

**Целевая зарплата при норме:** 75-95 тыс ₽/мес.

**Если HR — full-cycle (подбор + адаптация + удержание):** к окладу прибавить 15-20 тыс. Полная зарплата 90-115 тыс ₽/мес — оправдано размером сети 87-88 человек.
