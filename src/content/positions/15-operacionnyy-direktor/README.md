...
| 7 | [07-kpi-i-mesyachnye-metriki.md](07-kpi-i-mesyachnye-metriki.md) | KPI, формула премии (% от прибыли всей сети), годовая аттестация. Самая высокая зарплата в этой папке | Собственник, HR, ОД |
...
- Готовность платить рыночную зарплату (см. [`07-kpi-i-mesyachnye-metriki.md`](07-kpi-i-mesyachnye-metriki.md))
...
2. **Зарплата сильно выше.** ОД должен получать сравнимо с собственником (не «как наёмный сотрудник высокого уровня»). Иначе — не привлечёшь сильного человека.
...
2. **Сэкономить на зарплате** — ОД с зарплатой 80-100к (вместо 250-400к) — это либо стажёр, либо человек, у которого нет других опций. Сильный ОД не пойдёт.
