...
| Зарплата центральных функций | | | ✅ |
| Зарплата подчинённых центральных функций | | ✅ | |
| Бюджет на квартал | | | ✅ |
...
|---|---|---|
| **Оклад** | 250 000 - 400 000 ₽ | За факт работы |
| **% от прибыли всей сети** | 5-10% | Главная мотивация |
| **Премия годовая** | 2-4 оклада | По итогам годовой аттестации |
| **Опционная программа (если есть)** | 1-3% долей в перспективе | Долгосрочное удержание |

**Целевая зарплата при выполнении KPI:** 400 000 - 700 000 ₽ в месяц.

**Если хочется сэкономить:** не выйдет. ОД на 100-150к — это «сильный исполнитель», а не управленец. Это и есть текущая ситуация (помощник-директор).
...
5. **Финансовая мотивация — критична.** Без % от прибыли всей сети ОД не будет «бороться за каждый рубль». Это не наёмный сотрудник — это партнёр (хотя без юридического участия).
