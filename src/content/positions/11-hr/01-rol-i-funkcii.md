...
| Рекомендации сотрудников | Все | **Самая высокая** конверсия — за рекомендацию ввести бонус |
...
- На 90 день — итоговая встреча: остаёмся или нет, повышаем оклад или нет, перевод на постоянку
...
- Не принимает решения по зарплатам (готовит данные → решает собственник)
...
- Ведение базы сотрудников (Excel или 1С) — актуальные данные, контакты, должности, зарплаты
...
3. **Не назначает зарплаты** — готовит данные, решение принимает собственник + операционный директор
4. **Не считает зарплату** — это бухгалтерия
...
(РФ, РОП, методист)       (внешние)               (87-88 чел.)
   ...
   - Решение по               - Оформление             - Увольнение
     прохождению ИС         
                            ...
                            Бухгалтерия ◄─────────► HR
                            (зарплата, налоги)    (документы, табель)
```
...
| Бухгалтерия | Передаёт документы, табели | Считает зарплату и налоги |
