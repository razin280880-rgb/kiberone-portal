...
>
> — За 1 час [Имя ребёнка] сам(а) сделает свою компьютерную игру с помощью нейросети — реально играбельную, в браузере. Заберёт её домой ссылкой, сможет показать друзьям. Это наш обновлённый формат «AI-пробного». Сценарий: [`165-stsenariy-probnogo-ai-igra.md`](165-stsenariy-probnogo-ai-igra.md), эталон формулировок: [`165b-edinaya-formulirovka-ai-igra.md`](165b-edinaya-formulirovka-ai-igra.md).
>
