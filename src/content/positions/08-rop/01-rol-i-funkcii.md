...
**Подробный регламент, шаблон таблицы и порядок ведения:** [`reglament-mesyachnoy-analitiki-voronki.md`](reglament-mesyachnoy-analitiki-voronki.md).
...
**Где ведётся:**
- Базовая таблица — в Google Sheets по шаблону из [`reglament-mesyachnoy-analitiki-voronki.md`](reglament-mesyachnoy-analitiki-voronki.md) (доступ: РОП, собственник, ОД, методист — только чтение)
